...
import { generateCocktail } from './actions'
...
export default function Home() {
  ...
  const onSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const data = await generateCocktail(formData)
      const cocktail = typeof data === 'string' ? data : 'No data returned'
      setloading(false)
      setResult(cocktail)
    } catch (e) {
